...
import activitybg from "/vectorSvg/activitiesbg.png";
    ...
    <Container py="10">
      <div className=" mt-20 flex justify-between items-center gap-20">
        <div className="w-1/2 ">
          {/* <ComHeader
            dic="ACTIVITY"
            head="Camp Will Be For You <br /> What You Want It To Be."
          /> */}
          <p className="text-xl text-secondary">ACTIVITY</p>
          <h1 className="mb-14 text-3xl font-bold text-brandPrimary">
